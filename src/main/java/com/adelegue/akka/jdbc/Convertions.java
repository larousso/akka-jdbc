...
public class Convertions {
    ...
    public static ResultSetExtractor<Map<String, Object>> map = resultSet -> {
    ...
    public static <A> ResultSetExtractor<A> as(Class<A> classA) {
        return resultSet ->
                classA.cast(getAs(resultSet.getObject(1), classA));
    }

    public static <A, B> ResultSetExtractor<Pair<A, B>> as(Class<A> classA, Class<B> classB) {
        return resultSet ->
                Pair.apply(classA.cast(getAs(resultSet.getObject(1), classA)), classB.cast(getAs(resultSet.getObject(2), classB)));
    }

    public static <A, B, C> ResultSetExtractor<Tuple3<A, B, C>> as(Class<A> classA, Class<B> classB, Class<C> classC) {
        return resultSet ->
                Tuple3.apply(classA.cast(getAs(resultSet.getObject(1), classA)), classB.cast(getAs(resultSet.getObject(2), classB)), classC.cast(getAs(resultSet.getObject(3), classC)));
    }

    public static <A, B, C, D> ResultSetExtractor<Tuple4<A, B, C, D>> as(Class<A> classA, Class<B> classB, Class<C> classC, Class<D> classD) {
        return resultSet ->
                Tuple4.apply(classA.cast(getAs(resultSet.getObject(1), classA)), classB.cast(getAs(resultSet.getObject(2), classB)), classC.cast(getAs(resultSet.getObject(3), classC)), classD.cast(getAs(resultSet.getObject(4), classD)));
    }
